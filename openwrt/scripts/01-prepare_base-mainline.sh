...
#        git clone https://"$git_name":"$git_password"@$gitea/sbwml/target_linux_generic -b openwrt-24.10 target/linux/generic-6.18 --depth=1
    git clone https://$git_targetnew@$github/xianren78/target_linux_generic -b v6.18 target/linux/generic-6.18 --depth=1
fi
...
git clone https://$github/xianren78/package_kernel_mac80211 package/kernel/mac80211 -b v7.0.5
