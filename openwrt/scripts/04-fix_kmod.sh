...
if [ "$KERNEL_CLANG_LTO" = "y" ]; then
    ...
    git clone https://$github/xianren78/kmod_packages_net_xtables-addons feeds/packages/net/xtables-addons -b v6.18
    # netatop
    ...
    git clone https://$github/xianren78/feeds_packages_libs_dmx_usb_module feeds/packages/libs/dmx_usb_module
    # macremapper
    ...
    git clone https://$github/xianren78/kmod_packages_net_coova-chilli feeds/packages/net/coova-chilli
else
