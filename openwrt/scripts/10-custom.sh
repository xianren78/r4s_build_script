...
#    curl -s https://$github/torvalds/linux/commit/d96016a764f6aa5c7528c3d3f9cb472ef7266951.patch > target/linux/generic/backport-6.6/999-udp-Compute-L4-checksum-as-usual-when-not-segmenting-the-skb.patch
#fi
...
if [ "$MINIMAL_BUILD" = "y" ]; then
    if curl -s "https://$mirror/openwrt/24-config-minimal-common" | grep -q "^CONFIG_PACKAGE_luci-app-mihomo=y"; then
