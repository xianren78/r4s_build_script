...
if [ "$version" = "rc2" ]; then
    ...
    curl -s https://$github/xianren78/target_linux_generic/raw/refs/heads/main/hack-6.12/999-udp_offload-backto-43.patch > target/linux/generic/hack-6.12/999-udp_offload-backto-43.patch
fi
